...
<div class="ratings rating-hook">
  <div class="ratings-content">
    ...
    <split></split>
    <rating-select @toggleContent="toggle" @select="changeSelect" :select-type="selectType" :only-content="onlyContent" :ratings="ratings"></rating-select>
...
export default {
  ...
  created () {
    ...
    this.$nextTick(() => {
      if (!this.scroll) {
        let content = document.getElementsByClassName('rating-hook')[0]
